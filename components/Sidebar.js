...
import { AccountCircleSharp, AddTwoTone, DonutLargeRounded, ExitToAppRounded, RecentActorsTwoTone } from "@material-ui/icons"
...
function Sidebar() {
    ...
    return (
        <div className="md:w-1/6 w-1/3 h-screen fixed bg-white shadow-2xl top-0 z-30">
            <div className='border flex justify-around p-5'>
                <p className='text-xl font-semibold'>Attendence</p>
                <p>!</p>
            ...
            <div className='p-4 space-y-8'>
                <div className='space-y-6'>
                    ...
                    <Link href='/attendence' className='cursor-pointer'>
                        <div className='flex space-x-4 cursor-pointer'>
                            <RecentActorsTwoTone className='text-gray-300'/>
                            <p className='text-gray-600 text-lg font-light'>Attendence</p>
                        </div>
                    </Link>
                    <div onClick={() => router.push('/addUser')} className=''>
                        <div className='flex space-x-4 cursor-pointer'>
                            <AddTwoTone className='text-gray-300'/>
                            <p className='text-gray-600 text-lg font-light' >{isAdmin == true ? 'Add Teacher' : 'Add Student'}</p>
                        </div>
                    </div>
                    <div className=''>
                        <div className='flex space-x-4 cursor-pointer'>
